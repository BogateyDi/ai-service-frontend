...
const SectionRow = ({ section, onChange }) => {
    ...
    const ContentTypeButton = ({ type, currentType, label }) => (
        <button
            type="button"
...
export const ThesisForm = ({ onSubmit, remainingGenerations }) => {
